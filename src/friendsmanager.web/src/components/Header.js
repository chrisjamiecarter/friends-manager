            ...
            <nav className='bg-white shadow'>
                <div className='container flex items-center justify-between p-6 mx-auto text-slate-800 capitalize'>
                    ...
                    <ul className="sm:flex lg:gap-x-12">
                        ...
                        <li className="border-b-2 border-transparent hover:text-gray-800 transition-colors duration-300 transform hover:border-blue-500 mx-1.5 sm:mx-6"><Link to="/friend/contact">add contact</Link></li>
                    </ul>
                </div>
            </nav>
        </header>
